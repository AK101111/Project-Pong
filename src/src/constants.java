...
public final class constants {
    ...
    public static final int XCENTER = 30;//SCREEN_WIDTH / 2 - RADIUS;
    public static final int YCENTER = 350;
    ...
    public static final int[] testother = new int[]{};
    public static final int testactive = 0;
}
